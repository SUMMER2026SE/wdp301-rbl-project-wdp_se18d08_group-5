# rule_host_judgeHuman.md

# Debate Mode: Host + Judge Human
...
## 2. Ghi chú chế độ 1vs1 và 3vs3

* **1vs1:** Mỗi đội có 1 Speaker duy nhất đảm nhiệm cả 3 round (S1, S2, S3).
...
* Gửi feedback sau mỗi round.
* Submit Score cuối cùng lên hệ thống.
...
> Lưu ý: Tắt mic là tạm thời trong 3 giây chuyển tiếp. Người dùng có thể bật lại mic khi phase mới bắt đầu.

---

## 11. Free Time (Between Rounds)

Sau khi kết thúc mỗi round (sau CE):
* Timer reset về 00:00.
* Tất cả participant được tự do: mở mic, chat, camera.
* Judge thực hiện nhận xét và chấm điểm round vừa xong.
...
* Hoặc user (Debater / Judge / Host) có thể nhấn **View Result** để chuyển ngay.
...
[FREE TIME — Judge nhận xét & chấm điểm Round 1]
...
[FREE TIME — Judge nhận xét & chấm điểm Round 2]
...
[FREE TIME — Judge feedback & submit score cuối cùng]
Tất cả participant tự do: mic, chat, camera

↓ Judge submit score cuối cùng
