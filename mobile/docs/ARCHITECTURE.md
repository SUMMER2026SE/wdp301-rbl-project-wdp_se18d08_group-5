...
For a more detailed explanation of the architecture, see the [Architecture Guide](https://kevinluongdev.github.io/flutter_riverpod_clean_architecture/architecture.html).
