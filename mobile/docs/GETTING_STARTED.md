...
```bash
git clone https://github.com/kevinluongdev/flutter_riverpod_clean_architecture.git
...
1. Go to [the GitHub repository](https://github.com/kevinluongdev/flutter_riverpod_clean_architecture)
...
```bash
flutter create --template https://github.com/kevinluongdev/flutter_riverpod_clean_architecture my_new_app
cd my_new_app
flutter pub get
```
...
- Read the [Architecture Guide](https://kevinluongdev.github.io/flutter_riverpod_clean_architecture/architecture.html) to learn more about the project's architecture
