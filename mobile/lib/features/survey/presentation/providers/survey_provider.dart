...
class SurveyNotifier extends Notifier<SurveyState> {
  ...
  Future<bool> validateUsername(String username) async {
    final checkUsername = ref.read(checkUsernameUseCaseProvider);
  ...
  /// Submit survey with username validation
  Future<bool> submitWithValidation(Map<String, dynamic> formData) async {
    // Step 1: Validate username
    final username = formData['username'] as String;
    final isUsernameAvailable = await validateUsername(username);
